...
RSpec.describe Api::V1::ByLinesController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(get api_v1_by_lines_path).to route_to(controller: "api/v1/by_lines", action: "index", format: 'json')
    end

    it "routes to #show" do
      expect(get api_v1_by_lines_path(id: '1'))
        .to route_to(controller: "api/v1/by_lines", action: "show", id: "1", format: 'json')
    end


    it "routes to #create" do
      expect(post api_v1_create_by_lines_path(name: 'Writer'))
        .to route_to(controller: "api/v1/by_lines", action: "create", name: 'Writer', format: 'json')
    end

    it "routes to #update via PUT" do
      expect(patch api_v1_update_by_lines_path(id: '1'))
    ...
    it "routes to #destroy" do
      expect(delete api_v1_delete_by_lines_path(id: '1'))
