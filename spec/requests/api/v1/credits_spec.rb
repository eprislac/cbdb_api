...
RSpec.describe "/credits", type: :request do
  ...
  describe "GET /index" do
    let!(:credit) { create(:credit, valid_attributes) }

    it "renders a successful response" do
      get api_v1_credits_url, headers: valid_headers, as: :json
  ...
  describe "GET /show" do
    ...
    it "renders a successful response" do
      get api_v1_credit_url(credit), as: :json
      expect(response).to be_successful
    end
  end
  ...
  describe "PATCH /update" do
    ...
    context "with valid parameters" do
      let!(:new_by_line) { create(:by_line, name: "Artist") }
      let(:new_attributes) {
        { by_line_id: new_by_line.id }
      }

      it "updates the requested credit" do
        patch api_v1_credit_url(credit),
  ...
  describe "DELETE /destroy" do
    ...
    it "destroys the requested credit" do
      expect {
        delete api_v1_credit_url(credit), headers: valid_headers, as: :json
      }.to change(Credit, :count).by(-1)
    end
  end
end
